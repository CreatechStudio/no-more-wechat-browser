...
const translation: Dictionary<Dictionary<string>> = {
    'zh-cn': {
        ...
        "Currently not support view in Wechat. Please click more on top right corner and select `open in default browser`.": "暂不支持从微信/钉钉内直接访问，请点击右上角更多，选择\"在默认浏览器中打开\"",
        "powered by front": "由",
        "powered by end": "强力驱动",
    ...
    'en-us': {
        ...
        "Currently not support view in Wechat. Please click more on top right corner and select `open in default browser`.": "Currently not support to view in Wechat/DingTalk. Please click more on top right corner and select `open in default browser`.",
